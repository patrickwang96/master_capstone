...
dockerHubUsername="patrickwang96";
sudo docker tag ${function}:latest ${dockerHubUsername}/saaf-functions:${function}
sudo docker push ${dockerHubUsername}/saaf-functions:${function} >> ../${function}_ibm_build_progress.txt
